 ...
 */
export const matchResume = async (resumeText: string, activeRolesList: string): Promise<{
  name: string
  email: string
  phone: string
 ...
 */
export const analyzeEmail = async (emailSubject: string, emailBody: string): Promise<{
